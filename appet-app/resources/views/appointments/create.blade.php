...
<div id="event-create-container" class="col-md-6 offset-md-3" style="margin-bottom: 120px;">
    ...
    <form action="/appointments" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea required name="descricao" class="form-control" id="descricao" minlength="1" maxlength=200 placeholder="Faça uma breve observação sobre o que seu pet tem..."></textarea>
        </div>
        <div class="form-group">
