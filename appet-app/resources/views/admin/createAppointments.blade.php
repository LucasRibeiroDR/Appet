...
<div id="event-create-container" class="col-md-6 offset-md-3">
    ...
    <form action="/admin/create-Appointments/{{$user->id}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea required name="descricao" class="form-control" id="descricao" maxlength=200 placeholder="Faça uma breve observação sobre o que seu pet tem..."></textarea>
        </div>
        <div class="form-group">
