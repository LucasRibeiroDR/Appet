...
<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-5">
            <x-jet-danger-button class="btn-danger" wire:click="confirmUserDeletion" wire:loading.attr="disabled">
                {{ __('Deletar conta') }}
            </x-jet-danger-button>
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingUserDeletion">
            ...
            <x-slot name="footer">
                <x-jet-secondary-button class="btn btn-warning" wire:click="$toggle('confirmingUserDeletion')" wire:loading.attr="disabled">
                    {{ __('Cancelar') }}
                </x-jet-secondary-button>

                <x-jet-danger-button class="btn btn-danger ml-2" wire:click="deleteUser" wire:loading.attr="disabled">
                    {{ __('Deletar Conta') }}
                </x-jet-danger-button>
            </x-slot>
        </x-jet-dialog-modal>
